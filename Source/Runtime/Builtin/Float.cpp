    ...
    namespace Runtime
    {
        namespace Builtin
        {
            FloatType::FloatType()
            {
                ...
                this->set_attr(MagicMethodNames::as_method_name, XyA_Allocate(BuiltinFunction, float_object_as));
            }
            ...
            Object* float_object_as(Object** args, size_t arg_num, bool& exception_thrown)
            {
                XyA_Function_Check_Arg_Num(2)
                XyA_Builtin_Method_Get_Self(FloatObject)
