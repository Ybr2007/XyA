...
{    
    ...
    inline ObjectType variantIndexToType(unsigned short index)
    {
        switch (index)
        {
    ...
    inline unsigned short typeToVariantIndex(ObjectType type)
    {
        switch (type)
        {
    ...
    public:
        ...
        Object(const Number& value) : __value(ObjectValue(value)) {}
        Object(const Bool& value) : __value(ObjectValue(value)) {}
        Object(const String& value) : __value(ObjectValue(value)) {}
        Object(const List& value) : __value(ObjectValue(value)) {}
        Object(const Dict& value) : __value(ObjectValue(value)) {}
        Object(const ObjectValue& value) : __value(value) {}
